...
function Smallproudct(props) {
        ...
        return (
            ...
            <MDBCard className="p-2 w-100 ">
                <MDBCardImage src={props.proudct.img[0]} alt="MDBCard image cap" top hover
                    overlay="dark-slight"  />
                <MDBCardBody style={{
                    ...
                    <MDBCardTitle tag="h5" style={{margin:'0px'}} >{props.proudct.name}</MDBCardTitle>
                    <hr className='hr-light' style={{margin:'0px'}} />
                    <MDBCardText style={{margin:'0px'}}>
                        price: {props.proudct.price}$
                    </MDBCardText>
